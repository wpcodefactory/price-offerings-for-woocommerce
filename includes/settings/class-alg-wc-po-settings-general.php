		...
		$notes = array(
			array(
				...
				'desc'              => '<span class="dashicons dashicons-lightbulb"></span> ' .
					sprintf(
						/* Translators: %s: Offers dashboard link. */
						__( 'You can see and manage all price offers in the %s dashboard.', 'price-offerings-for-woocommerce' ),
						'<a href="' . admin_url( 'edit.php?post_type=alg_wc_price_offer' ) . '">' .
							__( 'Offers', 'price-offerings-for-woocommerce' ) .
						'</a>'
					),
