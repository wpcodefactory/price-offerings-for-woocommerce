...
* Dev - All WPFactory libraries moved to the `init` hook.
...
= 3.4.1 - 14/02/2025 =
* Fix - Doubled settings menu issue fixed.
* Dev - Compatibility - "Offer details for vendors" option added.
* Dev - Security - Escaping improved.
...
= 3.2.0 - 03/10/2024 =
* Fix - Auto-Accept - "Per product" option checked.
* Dev - "Auto-Reject" options added.
...
= 3.0.0 - 15/08/2024 =
* Fix - reCAPTCHA - JS error fixed.
* Dev - Pro - "Auto-Accept" options added.
* Dev - Developers - `alg_wc_po_price_offer_created` action added.
* Dev - Code refactoring.

= 2.9.9 - 10/08/2024 =
* Dev - Form - Optional reCAPTCHA field added.
